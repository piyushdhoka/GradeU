        ...
        <StickyBanner className="border-b border-zinc-800 bg-zinc-900">
          <p className="px-4 text-center text-sm font-medium tracking-wide text-zinc-300">
            ...
            <button
              ...
              className="text-brand-400 ml-2 font-bold hover:underline"
            >
              Join Community &rarr;
            </button>
          </p>
          ...
          <MobileNav>
            ...
            <MobileNavMenu isOpen={mobileOpen} onClose={() => setMobileOpen(false)}>
              <button
                ...
                className="hover:text-brand-400 text-sm font-medium text-zinc-300 transition-colors"
              >
                Features
              </button>
              <button
              ...
              <button
                ...
                className="hover:text-brand-400 flex items-center gap-2 text-sm font-medium text-zinc-300 transition-colors"
              >
                ...
                >
                  ...
                  <defs>
                    <linearGradient
                      id="paint0_linear_87_7225_mobile"
                      x1="16"
                      y1="2"
                      x2="16"
                      y2="30"
