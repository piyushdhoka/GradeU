    ...
    <>
      <div className="dark flex min-h-svh flex-col items-center justify-center gap-6 bg-zinc-950 p-6 md:p-10">
        <div className="flex w-full max-w-md flex-col gap-6">
          <Link
            href="/"
            className="group mb-4 flex flex-col items-center gap-4 self-center font-medium transition-all hover:opacity-90 focus:outline-none"
          >
          ...
          <Card className="border-zinc-800/50 bg-zinc-900/50 shadow-2xl backdrop-blur-xl">
            ...
            <CardContent>
              ...
              <FieldGroup className="gap-6">
                ...
                <Field>
                  <div className="mt-6 text-center text-xs leading-relaxed text-zinc-500">
