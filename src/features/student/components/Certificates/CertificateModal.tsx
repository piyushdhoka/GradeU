...
export const CertificateModal: React.FC<CertificateModalProps> = ({
  ...
  const uploadAndSave = async (blob: Blob) => {
    ...
    if (!courseId) {
      ...
      const { data: newCourseRows } = await supabase
        .from('courses')
  ...
  const downloadCertificate = async () => {
    ...
    try {
      ...
      alert(
        'Could not generate certificate download. Please try again or check console for details.'
      );
    } finally {
  ...
  return (
    <div className="bg-opacity-80 fixed inset-0 z-50 flex items-center justify-center bg-black p-4">
      <div className="flex w-full max-w-5xl flex-col overflow-hidden rounded-lg bg-white shadow-2xl">
        {/* Certificate Area */}
          ...
          >
            ...
            >
              ...
              >
                <img
                  src="/logo.svg"
                  alt="GradeU"
                  style={{ height: '64px', objectFit: 'contain', maxWidth: '200px' }}
                />
              </div>
              ...
              >
                an online non-credit course authorized by GradeU and offered through the GradeU
                Academic Initiative.
              </p>
              ...
              <div style={{ marginTop: 'auto' }}>
                {isVU && facultyName ? (
                  <div style={{ marginBottom: '16px' }}>
                    ...
                    >
                      Faculty Guide, Vishwakarma University
                    </p>
                  </div>
                ) : (
                  <div>
            ...
            >
              ...
              <div style={{ paddingLeft: '24px', paddingRight: '24px', textAlign: 'center' }}>
                ...
                >
                  Verify at sovap.security/verify/T4TNDR
                  <br />
        ...
        {/* Footer Controls */}
        <div className="flex items-center justify-end gap-4 border-t border-white/10 bg-zinc-900 px-6 py-4">
          <Button
            variant="ghost"
            onClick={onClose}
