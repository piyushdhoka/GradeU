      ...
      questions: [
        {
          ...
          difficulty: 'easy',
          explanation:
            'HTTPS (Hypertext Transfer Protocol Secure) uses TLS to encrypt communications, preventing attackers from reading sensitive data.',
        },
        {
          id: 'q1-2',
          ...
          options: [
            ...
            'The server sending data back to the client',
            'The browser closing',
          ...
          difficulty: 'easy',
          explanation:
            'A response is the message sent by the server to the client after receiving a request.',
        },
        {
          id: 'q1-3',
          ...
          difficulty: 'medium',
          explanation:
            'Wireshark and Burp Suite are standard tools for sniffing and analyzing network traffic.',
        },
        {
          id: 'q1-4',
        ...
        },
        {
          ...
          difficulty: 'medium',
          explanation:
            'The Cookie header usually carries the session ID used for state management.',
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          difficulty: 'medium',
          explanation:
            'The HttpOnly flag directs the browser not to expose the cookie to client-side scripts (like JavaScript), mitigating XSS risks.',
        },
        {
          id: 'q3',
          question:
            'A user logs in successfully but cannot access the admin page. This is an issue of:',
          options: ['Authentication', 'Authorization', 'Session Fixation', 'Input Validation'],
          correctAnswer: 1,
          difficulty: 'medium',
          explanation:
            'Authorization determines what an authenticated user is permitted to do. The user is authenticated (logged in) but not authorized for the admin page.',
        },
        {
          id: 'q2-3',
          ...
          options: [
            ...
            'Prevents deletion',
            'Hides cookie from user',
          ],
          correctAnswer: 1,
          difficulty: 'medium',
          explanation:
            'The Secure attribute ensures the cookie is only transmitted over encrypted (HTTPS) connections.',
        },
        {
          id: 'q2-4',
        ...
        },
        {
          ...
          difficulty: 'medium',
          explanation:
            'Session Hijacking involves stealing a valid session ID to impersonate a user.',
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          difficulty: 'hard',
          explanation:
            'Client-side validation can be bypassed. Server-side validation is mandatory.',
        },
        {
          id: 'q5-2',
          question: 'What is Sniffing?',
          options: [
            'Smelling hardware issues',
          ...
          difficulty: 'easy',
          explanation:
            'Sniffing involves intercepting and capturing data packets traversing a network.',
        },
        {
          id: 'q5-3',
          question:
            'Modifying URL parameters (e.g. ?id=5 to ?id=6) to access other data is known as:',
        ...
        },
        {
          ...
          difficulty: 'easy',
          explanation:
            'Encryption (HTTPS) prevents sniffers from reading the content of captured traffic.',
        },
        {
          id: 'q5-5',
      ...
      questions: [
        {
          id: 'q4',
          question:
            'An attacker changes ?user_id=123 to ?user_id=124 and views another profile. This is:',
          options: ['SQL Injection', 'XSS', 'IDOR', 'Broken Authentication'],
          correctAnswer: 2,
          difficulty: 'medium',
          explanation:
            'IDOR (Insecure Direct Object Reference) is a type of Access Control failure.',
        },
        {
          id: 'q4-2',
          ...
          difficulty: 'medium',
          explanation:
            'Privilege Escalation occurs when a user gains access to resources reserved for higher-privileged accounts.',
        },
        {
          id: 'q4-3',
          ...
          difficulty: 'easy',
          explanation:
            'It covers vulnerabilities where restrictions on what authenticated users can do are not properly enforced.',
        },
        {
          id: 'q4-4',
          ...
          options: [
            'Slow loading images',
            'Unauthorized sites reading API data',
            'Broken layout',
            'Server timeout',
          ],
          correctAnswer: 1,
          difficulty: 'hard',
          explanation:
            'Overly permissive CORS headers can allow arbitrary websites to read sensitive data from your API.',
        },
        {
          id: 'q4-5',
          ...
          difficulty: 'medium',
          explanation:
            'Accessing hidden or restricted URLs without proper authorization checks is a Broken Access Control issue.',
        },
      ],
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            'It makes code ugly',
            'Anyone with code access can steal them',
            'Compiler errors',
            'It slows execution',
          ],
          correctAnswer: 1,
          difficulty: 'easy',
          explanation:
            'Source code is often shared or visible; secrets should be in environment variables or vaults.',
        },
        {
          id: 'm5-q4',
          ...
          difficulty: 'medium',
          explanation:
            'Bcrypt (and Argon2) are designed to be slow and salt automatically, making them safe for passwords.',
        },
        {
          id: 'm5-q5',
          ...
          difficulty: 'easy',
          explanation:
            'Encryption ensures data is kept confidential and readable only by authorized parties.',
        },
      ],
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            'Sequential Query Language Input',
            'Structured Query Language Injection',
            'Simple Query Logic Interface',
            'Server Query Link Index',
          ],
          correctAnswer: 1,
          difficulty: 'easy',
      ...
      questions: [
        {
          ...
          difficulty: 'medium',
          explanation:
            'It refers to logical or architectural flaws that cannot be fixed just by coding better.',
        },
        {
          id: 'm2-q7',
        ...
        },
        {
          ...
          difficulty: 'easy',
          explanation:
            'Leaving default configurations active is a classic Security Misconfiguration.',
        },
        {
          id: 'm7-q4',
          ...
          difficulty: 'medium',
          explanation:
            'Insecure design is fixed by better planning, threat modeling, and following secure architecture patterns.',
        },
        {
          id: 'm7-q5',
          ...
          options: [
            'It looks ugly',
            'It reveals internal system details to attackers',
          ...
          difficulty: 'medium',
          explanation:
            'Stack traces can leak paths, versions, and logic that help attackers plan further attacks.',
        },
      ],
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          difficulty: 'medium',
          explanation:
            'Credential Stuffing works because users recycle passwords; attackers try breached credentials on other sites.',
        },
        {
          id: 'm8-q4',
        ...
        },
        {
          ...
          options: [
            'It was a vulnerable component used everywhere',
          ...
          difficulty: 'easy',
          explanation:
            'Log4j was a widely used library with a critical RCE vulnerability (Vulnerable Component).',
        },
      ],
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            'Simple Server Routing Function',
            'Secure Socket Relay Function',
          ],
          correctAnswer: 0,
          difficulty: 'easy',
        ...
        },
        {
          ...
          options: [
            ...
            'Persist in a network undetected',
            'Crash the server',
            'See the UI',
          ],
          correctAnswer: 1,
          difficulty: 'medium',
          explanation:
            'Without logs, you cannot detect that an attack is happening or investigate how it happened.',
        },
        {
          id: 'm9-q4',
          ...
          difficulty: 'hard',
          explanation:
            'Deserializing untrusted data can allow attackers to execute arbitrary code (RCE).',
        },
        {
          id: 'm9-q5',
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            'Making scary graphics',
            'Identifying potential threats during design',
            'Hacking a live server',
        ...
        },
        {
          ...
          options: [
            ...
            'Simple App Security Tool',
            'Server Admin System Test',
            'Secure Apps Static Test',
          ],
          correctAnswer: 0,
          difficulty: 'medium',
        ...
        },
        {
          ...
          difficulty: 'medium',
          explanation:
            'DAST (Dynamic Application Security Testing) interacts with the running application (Black box).',
        },
        {
          id: 'm10-q5',
          ...
          difficulty: 'hard',
          explanation:
            'STRIDE (Spoofing, Tampering, Repudiation, Info Disclosure, Denial of Service, Elevation of Priv) categories threats.',
        },
      ],
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          difficulty: 'medium',
          explanation:
            'Preparation is the key first step to ensuring you can handle an incident when it occurs.',
        },
        {
          id: 'm11-q4',
        ...
        },
        {
          ...
          options: [
            ...
            'Proactively testing and monitoring',
          ...
          difficulty: 'medium',
          explanation:
            'Active defense involves proactive measures like pen-testing and real-time monitoring.',
        },
      ],
    },
    {
      ...
      description:
        'Comprehensive exam covering all modules. Passing this exam unlocks your certificate.',
      course_id: 'vu-web-security',
      order: 12,
      module_order: 12,
      content: `
