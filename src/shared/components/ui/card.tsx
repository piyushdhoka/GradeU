...
const cardVariants = cva('rounded-xl overflow-hidden', {
  variants: {
    variant: {
      ...
      cyber:
        'bg-gray-900/80 backdrop-blur-xl border border-cyber-500/30 shadow-[0_0_15px_rgba(14,165,233,0.1)]',
    },
    hover: {
...
const CardDescription = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn('text-muted-foreground mt-2 text-sm', className)} {...props} />
  )
);
