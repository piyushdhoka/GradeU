export const siteConfig = {
  ...
  description:
    'The complete platform to learn, practice, and achieve your academic goals. AI-powered education platform with hands-on labs, proctored assessments, and career tools. No fluff, just results.',
