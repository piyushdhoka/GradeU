...
const COURSES = [
  {
    ...
    description:
      'Master the core principles of securing web applications, including OWASP Top 10, headers, and authentication.',
  ...
  },
  {
    ...
    description:
      'Learn to analyze network traffic, identify anomalies, and implement robust defense mechanisms.',
  ...
  },
  {
    ...
    description:
      'Hands-on practical guide to offensive security, tools usage, and vulnerability exploitation.',
...
export const runSeed = async (userId?: string) => {
  ...
  try {
    ...
    const { error: cErr } = await supabase
      .from('courses')
      .upsert(coursesPayload, { onConflict: 'id' });
